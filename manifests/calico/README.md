...
- For a second Kubernetes cluster that should only participate through host policy, do not install a second in-cluster Calico deployment. Onboard those nodes as external hosts instead.
